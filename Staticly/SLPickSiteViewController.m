...
@interface SLPickSiteViewController ()

@property (strong, nonatomic) NSArray *sites;

@end

@implementation SLPickSiteViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row == self.sites.count){
        ...
        cell.detailTextLabel.text = [[self.sites objectAtIndex:indexPath.row] fullName];
    }
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if(indexPath.row == self.sites.count + 1){
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if([segue.identifier isEqualToString:@"addNewSite"]){
